...
//        String sql = "delete a1 p1,p2,p3,jsonPath('$..book[0][\"category\"]') where 51 in (select p4 from b1 as p4)";
        ...
        System.out.println("最终结果 table a1 :"+JsonSqlVisitor.getResult("a1"));
        System.out.println("最终结果 table b1 :"+JsonSqlVisitor.getResult("b1"));
    }
    ...
    private static void registerCustomMethod() {
        try {
            ...
            JsonSqlVisitor.registerFunction("a", a,Number.class, Object.class);
            JsonSqlVisitor.registerFunction("b", b,BigDecimal.class, BigDecimal.class);
            JsonSqlVisitor.registerFunction("c", c,BigDecimal.class, BigDecimal.class);
            JsonSqlVisitor.registerFunction("d", d);

            JsonSqlVisitor.registerMacro("c", MacroEnum.ORIGINAL_JSON,MacroEnum.READ_DOCUMENT,MacroEnum.ORIGINAL_WRITE_DOCUMENT,MacroEnum.COPY_WRITE_WRITE_DOCUMENT,MacroEnum.CUR_WRITE_DOCUMENT);
            JsonSqlVisitor.registerMacro("d", MacroEnum.ORIGINAL_JSON,MacroEnum.READ_DOCUMENT,MacroEnum.ORIGINAL_WRITE_DOCUMENT,MacroEnum.COPY_WRITE_WRITE_DOCUMENT,MacroEnum.CUR_WRITE_DOCUMENT);
