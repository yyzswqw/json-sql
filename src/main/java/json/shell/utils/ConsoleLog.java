...
public class ConsoleLog {
	...
	public ConsoleLog(OutputStream out){
		this(out,true);
	}

	public ConsoleLog(OutputStream out,boolean output){
		this(out,out,output);
	}

	public ConsoleLog(OutputStream out,OutputStream err,boolean output){
		this.output = output;
	 ...
	 */
	public void log(Object obj1, Object... otherObjs) {
	 ...
	 * @param values   值
	 */
	public void log(String template, Object... values) {
	 ...
	 * @param values   值
	 */
	public void log(Throwable t, String template, Object... values) {
		if(!output){
			return;
		}
		this.out.println(StrUtil.format(template, values));
		if (null != t) {
	 ...
	 * @param values   值
	 */
	private void logInternal(String template, Object... values) {
	 ...
	 */
	public void table(ConsoleTable consoleTable) {
		print(consoleTable.toString());
	}

	/**
	 * 同 System.out.print()方法
	 *
	 * @param obj 要打印的对象
	 */
	 ...
	 * @param otherObjs 其它要打印的对象
	 */
	public void print(Object obj1, Object... otherObjs) {
		if (ArrayUtil.isEmpty(otherObjs)) {
			print(obj1);
		} else {
	 ...
	 * @param len      打印长度
	 */
	public void printProgress(char showChar, int len) {
	 ...
	 */
	public void printProgress(char showChar, int totalLen, double rate) {
	 ...
	 * @param values   值
	 */
	private void printInternal(String template, Object... values) {
		if(!output){
			return;
		}
		this.out.print(StrUtil.format(template, values));
	}

	// --------------------------------------------------------------------------------- Error

	/**
	 * 同 System.err.println()方法
	 */
	public void error() {
		if(!output){
			return;
	 ...
	 * @param otherObjs 其它要打印的对象
	 */
	public void error(Object obj1, Object... otherObjs) {
		if (ArrayUtil.isEmpty(otherObjs)) {
			error(obj1);
		} else {
	...
	public void error(Throwable t, String template, Object... values) {
		...
		this.err.println(StrUtil.format(template, values));
		if (null != t) {
	 ...
	 * @param values   值
	 */
	private void errorInternal(String template, Object... values) {
